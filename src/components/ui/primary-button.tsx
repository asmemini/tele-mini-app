...
const primaryClassName =
  "inline-flex h-14 w-full items-center justify-center rounded-button bg-brand px-5 text-base font-bold text-white shadow-glow transition-[transform,background-color] duration-150 touch-manipulation hover:bg-brand-dark active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand disabled:pointer-events-none disabled:opacity-60";
